<p align="center">
  <a href="README.md"><img src="https://img.shields.io/badge/lang-English-555555?style=flat-square" alt="English"></a>
  <a href="README.zh-CN.md"><img src="https://img.shields.io/badge/lang-简体中文-0369a6?style=flat-square" alt="简体中文"></a>
</p>
...
- 测试：**Vitest**、**Playwright**（`npm run test`、`npm run test:e2e`）
...
```bash
npm run preview   # OpenNext 本地预览
npm run deploy    # OpenNext + Cloudflare 部署
```
...
若你改进产品文案或流程，欢迎同步更新本 README，使新读者能直接理解「递归学习」在实践里长什么样。**英文默认说明请见 [README.md](README.md)。**
